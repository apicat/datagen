...
func init() {
	functions = map[string]FuncHandler{
		...
		"provinceorstate&city": func(p Param) any { return ProvinceorStateCity(p.Loc...) },
		"street":               func(p Param) any { return Street(p.Args...) },
		...
		"longitude&latitude":   func(p Param) any { return LongitudeAndLatitude() },
	}
}
